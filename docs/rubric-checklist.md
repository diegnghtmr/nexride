...
Commit: HEAD on main (tag v0.1.19-mvp; históricamente v0.1.18-mvp / v0.1.17-mvp / v0.1.16-mvp / v0.1.15-mvp / v0.1.14-mvp / v0.1.13-mvp)
CI Run: see v0.1.19-mvp CI run on main (7/7 green; históricamente v0.1.18-mvp y v0.1.17-mvp 7/7 green)
