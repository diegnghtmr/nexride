...
| F5 | RTF-25 / AuditAction type | Resuelto en v0.1.10-mvp | `AuditAction` TS union narrowed: `'ACTIVATE'` eliminado. DB CHECK constraint intacto (sin riesgo). | `src/safe-points/infrastructure/safe-point-audit.entity.ts:3` |
